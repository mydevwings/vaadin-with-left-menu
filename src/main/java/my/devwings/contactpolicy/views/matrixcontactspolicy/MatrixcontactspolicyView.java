package my.devwings.contactpolicy.views.matrixcontactspolicy;
...
@Route(value = "matrix-contacts-policy", layout = MainView.class)
@RouteAlias(value = "", layout = MainView.class)
@PageTitle("Matrix contacts policy")
@CssImport("styles/views/matrixcontactspolicy/matrixcontactspolicy-view.css")
public class MatrixcontactspolicyView extends Div implements AfterNavigationObserver {
    ...
    public MatrixcontactspolicyView() {
        setId("matrixcontactspolicy-view");
        // Configure Grid
        employees = new Grid<>();
