package my.devwings.contactpolicy.views.settingsforcontactspolicy;
...
@Route(value = "settings-for-matrix-contacts-policy", layout = MainView.class)
@PageTitle("Settings for contacts policy")
@CssImport("styles/views/settingsforcontactspolicy/settingsforcontactspolicy-view.css")
public class SettingsforcontactspolicyView extends Div implements AfterNavigationObserver {
    ...
    public SettingsforcontactspolicyView() {
        setId("settingsforcontactspolicy-view");
        // Configure Grid
        employees = new Grid<>();
