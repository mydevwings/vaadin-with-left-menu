package my.devwings.contactpolicy.views.matrixcrosschecks;
...
@Route(value = "matrix-cross-checks", layout = MainView.class)
@PageTitle("Matrix Cross Checks")
@CssImport("styles/views/matrixcrosschecks/matrix-cross-checks-view.css")
public class MatrixCrossChecksView extends Div implements AfterNavigationObserver {
    ...
    public MatrixCrossChecksView() {
        setId("matrix-cross-checks-view");
        // Configure Grid
        employees = new Grid<>();
