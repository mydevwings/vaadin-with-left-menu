package my.devwings.contactpolicy.views.settingsformatrixcrosschecks;

import org.springframework.beans.factory.annotation.Autowired;

import my.devwings.contactpolicy.backend.BackendService;
import my.devwings.contactpolicy.backend.Employee;
...
import my.devwings.contactpolicy.MainView;
@Route(value = "settings-for-matrix-cross-checks", layout = MainView.class)
@PageTitle("Settings for matrix cross checks")
@CssImport("styles/views/settingsformatrixcrosschecks/settingsformatrixcrosschecks-view.css")
public class SettingsformatrixcrosschecksView extends Div implements AfterNavigationObserver {
    ...
    public SettingsformatrixcrosschecksView() {
        setId("settingsformatrixcrosschecks-view");
        // Configure Grid
        employees = new Grid<>();
