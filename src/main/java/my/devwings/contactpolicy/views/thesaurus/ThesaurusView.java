package my.devwings.contactpolicy.views.thesaurus;
...
@Route(value = "thesaurus", layout = MainView.class)
@PageTitle("Thesaurus")
@CssImport("styles/views/thesaurus/thesaurus-view.css")
public class ThesaurusView extends Div implements AfterNavigationObserver {
